<template>
  <div class="px-10 my-10">
    <div class="mx-auto prose prose-xl word-wraping">
      <div class="mb-10">
        <svg
      ...
      <p>
        Nulla eiusmod tempor minim elit. Consequat ullamco sunt magna nostrud
        voluptate. Ea consectetur anim deserunt duis minim dolore ad tempor
        minim laborum laboris quis sint eu. Excepteur exercitation in dolor esse
        laborum cillum cupidatat velit laborum dolore eu nulla tempor. Labore
        nulla veniam pariatur reprehenderit officia adipisicing aliquip dolor
        amet et. Aliquip reprehenderit velit dolor fugiat deserunt tempor et
        exercitation. In aliqua officia et nostrud nisi cupidatat qui est in id
        veniam eiusmod duis ut.
      </p>
      <p>
        Consequat enim Lorem sunt sint id mollit nisi nulla nostrud anim
        proident. Exercitation amet exercitation ullamco nulla ut sint eu elit
        officia occaecat irure elit veniam. Non fugiat non cupidatat amet
        voluptate dolor nostrud. Incididunt est duis id officia est nulla.
        Laborum aliqua commodo duis nulla proident ea eiusmod cupidatat pariatur
        cillum qui.
      </p>
      <p>
        Commodo sint proident consequat sint eiusmod Lorem ea anim in sunt culpa
        excepteur velit. Reprehenderit magna nostrud dolore nulla exercitation
        enim Lorem. Magna do laborum dolore occaecat. Ipsum magna exercitation
        culpa ea tempor cillum incididunt duis occaecat do reprehenderit fugiat.
        Eiusmod tempor do non do tempor ut do ut qui occaecat et sunt. Esse aute
        sint tempor anim eiusmod duis mollit aliquip exercitation dolore fugiat
        sit. Dolor ad sunt duis pariatur aliquip eu aute do sunt.
      </p>
      <p>
        Ipsum commodo ut eu in amet esse ullamco labore occaecat culpa labore
        excepteur ipsum nostrud. Velit tempor ut cillum voluptate elit
        consectetur fugiat magna elit occaecat. In occaecat incididunt officia
        eiusmod eiusmod ut officia aliquip quis sint sunt exercitation officia.
      </p>
      <p>
        Do duis laborum veniam sit nostrud ullamco excepteur tempor ad
        exercitation adipisicing. Pariatur enim adipisicing nostrud occaecat
        pariatur occaecat irure pariatur. Veniam magna commodo aliquip
        adipisicing aliqua deserunt tempor nulla. Ea laborum anim sit culpa qui
        proident. Ex minim sit id ea laboris exercitation commodo consectetur
        anim tempor duis adipisicing aliquip dolore.
      </p>
    </div>
